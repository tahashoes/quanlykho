...
- Mã sản phẩm được điền sẵn theo danh mục: Vớ `VO-001`, Xịt khử mùi `XKM-001`, Băng keo `KEO-001`, Thùng Carton `CARTON-001` và Giấy in `GIAYIN-001`; riêng Giày vẫn nhập mã thủ công.
...
- Tab Đơn hàng riêng hiển thị toàn bộ đơn bằng các thẻ có viền rõ, kèm tổng số đơn, doanh thu, chi phí và lợi nhuận ở đầu trang. Sáu trạng thái gồm: Đang chờ lấy hàng, Đang vận chuyển, Đã giao, Hoàn thành, Đã Hủy và Trả Hàng. Hoàn thành/Hủy/Trả là trạng thái kết thúc; Hủy/Trả hoàn kho đúng một lần và đưa doanh thu đơn về 0.
...
- Lịch sử xuất hàng là nhật ký chỉ đọc, mỗi đơn chỉ hiển thị một lần với sản phẩm chính và các sản phẩm đi kèm thu gọn bên dưới; đồng thời ghi nhận thời gian, người xuất, mã đơn và kênh bán.
...
- Báo cáo theo ngày, tuần, tháng, quý hoặc năm:
...
- Có thể tải báo cáo đúng kỳ đang xem dưới dạng Excel (`.xlsx`) hoặc PDF, gồm tổng quan, số liệu theo kênh và chi tiết từng đơn hàng.
...
- **Node.js 24**: máy chủ HTTP nhẹ; ExcelJS và PDFKit tạo tệp báo cáo trực tiếp trên máy chủ.
